...
public class Address implements Serializable{
	...
	@NotBlank(message="Campo dettaglio indirizzo obbligatorio")
	private String addressLineTwo;
	
	@NotBlank(message="Campo città obbligatorio")
	private String city;
	
	@NotBlank(message="Campo regione obbligatorio")
	private String state;
	
	@NotBlank(message="Campo nazione obbligatorio")
